...
def optimize(starting_number, epsilon, allowed_error, function_to_optimize):
    ...
    print(first_numerical_derivative(a = 2, epsilon_derivative = 0.0001, function = function_to_optimize))
    ...
    print(second_numerical_derivative(b = 2, epsilon_derivative = 0.0001, function = function_to_optimize))
    ...
    output_first_step = taylor_step(starting_value = 2, epsilon_taylor = 0.0001, function_taylor = function_to_optimize)
